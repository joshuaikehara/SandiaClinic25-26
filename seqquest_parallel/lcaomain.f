...
ctp:start
          matdist = mat
CTP          call PSOLVSIZES( -1,norb,norb,nlocrow,nloccol,lwork )
CTP          matdist = nlocrow*nloccol
...
ctp:
          call ERLSOLV(
CTP          call PERLSOLV( icluster, gapp, nlocrow, nloccol,
     $     idosolv,scut, nspin,
...
ctp:
          call EIGSOLV(
CTP          call PEIGSOLV( masterlist,do_kppsolve, do_psolv,
